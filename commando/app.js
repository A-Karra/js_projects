...
// todoItem.addEventListener('click', copy2Clipboard);
...
function copy2Clipboard(todo) {
    ...
    const todoIndex = todo.children[0].innerText;
    let index = todos.findIndex(obj => obj.todo==todoIndex);
    currentTodo = todos[index].todo;
    navigator.clipboard.writeText(currentTodo);
